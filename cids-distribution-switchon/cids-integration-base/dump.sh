...
pg_dump --host localhost --port 5434 --username "postgres" --format plain --section pre-data --section post-data --section data --encoding UTF8 --file "/tmp/switchon_themes.sql" --table "contact" --table "geom" --table "metadata" --table "relationship" --table "representation" --table "resource" --table "tag" --table "taggroup" --table "jt_*" --inserts "switchon"

more /tmp/switchon_themes.sql > import/switchon.sql

# export cids data (schema already created by cids_init.sql!)
pg_dump --host localhost --port 5434 --username "postgres" --format plain --section data --encoding UTF8 --file "/tmp/switchon_cids.sql" --table "cs_*" --exclude-table "cs_config_attr_jt" --exclude-table "cs_locks" --exclude-table "cs_cache" --exclude-table "cs_attr_object" --exclude-table "cs_attr_object_derived" --exclude-table "cs_attr_string" --inserts "switchon"
